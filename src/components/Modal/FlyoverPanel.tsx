...
function FlyoverPanel({
  ...
  return (
    <>
      ...
      <div 
        className={`fixed inset-0 transition-all duration-500 bg-white dark:bg-slate-900/50 z-[89]
          perspective-[2000px] overflow-hidden     
          ${flyoverState.isOpen 
            ? 'opacity-90 backdrop-blur-[2px]  backdrop-filter backdrop-saturate-150 dark:backdrop-blur-[2px] dark:backdrop-filter dark:backdrop-saturate-150 '
            : 'opacity-0 pointer-events-none dark:bg-slate-900 dark:backdrop-blur-[2px] dark:backdrop-filter dark:backdrop-saturate-150'
          }
        `}
      ...
      >
        ...
        <div 
          className={`absolute inset-0 bg-gradient-to-br  dark:bg-slate-900/50 from-black/5 via-black/1 to-transparent
            backdrop-blur-[8px] transition-all duration-700 transform-gpu 
            shadow-[inset_0_0_100px_rgba(255,255,255,0.1)]  
            ${flyoverState.isOpen ? 'scale-100 opacity-100 dark:bg-slate-900/50' : 'scale-125 rotate-12 opacity-0'}
          `}
        />
        ...
        <div 
          className={`absolute inset-0 grid grid-cols-5 grid-rows-5
            ...
            ${flyoverState.isOpen ? 'scale-100 opacity-100 dark:bg-slate-900' : 'scale-150 opacity-0'}
          `}
        >
          {[...Array(25)].map((_, i) => {
            ...
            return (
              <div
                key={i}
                className={`relative overflow-hidden backdrop-blur-[6px] dark:bg-slate-900/50 dark:backdrop-blur-[6px]     
                  before:absolute before:inset-0  
                  before:bg-gradient-to-br before:from-white/20 before:via-transparent before:to-black/10 dark:before:from-white/20 dark:before:via-transparent dark:before:to-black/10
                  after:absolute after:inset-0 
                  after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.3),transparent)] dark:after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.3),transparent)]
                  transition-all duration-700 ease-out
                  transform-gpu origin-center
                  hover:z-10 hover:scale-110 hover:rotate-0
                  group cursor-pointer
                  shadow-[0_0_15px_rgba(255,255,255,0.1)] dark:shadow-[0_0_15px_rgba(255,255,255,0.1)]  
                  hover:shadow-[0_0_35px_rgba(255,255,255,0.4)] dark:hover:shadow-[0_0_35px_rgba(255,255,255,0.4)]
                  hover:bg-gradient-to-br hover:from-white/30 hover:to-blue-200/30 dark:hover:bg-gradient-to-br dark:hover:from-white/30 dark:hover:to-blue-200/30
                  hover:backdrop-blur-[12px] dark:hover:backdrop-blur-[12px]
                  active:scale-95
                `}
                style={{
              ...
              >
                ...
                <div 
                  className={`absolute inset-0 opacity-0 group-hover:opacity-100 dark:bg-slate-900/50     
                ...
                <div 
                  className={`absolute inset-0 opacity-0 group-hover:opacity-100
                    bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.45),transparent_60%)] dark:bg-slate-900/50     
                    after:absolute after:inset-0 
                    after:bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.15),transparent_70%)] dark:after:bg-slate-900/50       
                    before:absolute before:inset-0
                    before:bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.3),transparent_80%)] dark:before:bg-slate-900/50           
                ...
                <div 
                  className={`absolute inset-0 opacity-0 group-hover:opacity-100
                    bg-gradient-to-r from-transparent via-blue-100/40 to-transparent dark:bg-slate-900/50    
      ...
      <aside
        className={`
          fixed inset-y-0 right-0 w-full max-w-96 bg-white/95  backdrop-blur-sm dark:backdrop-blur-sm   dark:bg-slate-900/50
          shadow-[0_0_40px_rgba(0,0,0,0.1)] dark:shadow-[0_0_40px_rgba(0,0,0,0.1)] flex flex-col
          transform transition-all duration-300 ease-out z-[90] 
          ${flyoverState.isOpen ? 'translate-x-0' : 'translate-x-full'}
        `}
      >
        {/* Header */}
        <div className="h-16 flex items-center justify-between px-6 bg-gradient-to-r from-blue-50/80 dark:from-blue-900/20 to-purple-50/80 dark:to-purple-900/20 border-b border-gray-200 dark:border-slate-700 dark:text-gray-100 dark:hover:bg-slate-900/60">
          <h2 className="text-xl font-semibold text-gray-900 tracking-tight  dark:text-gray-100">
            {getFlyoverTitle(flyoverState.type)}
          </h2>
          <button
            onClick={() => setFlyoverState({ isOpen: false, type: null, data: null })}
            className="text-gray-500 hover:text-gray-700 dark:text-gray-400  dark:hover:text-gray-300 transition-colors duration-200 p-2 rounded-full hover:bg-gray-100/50 dark:hover:bg-slate-700/50"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          <div className="flex-1 overflow-y-auto px-6 py-4 scrollbar-thin  scrollbar-thumb-gray-200 scrollbar-track-transparent dark:scrollbar-thumb-gray-700 *:dark:scrollbar-track-transparent">
          ...
          <div className="flex items-center justify-end gap-3 px-6 py-4 bg-gradient-to-r from-blue-50/80 dark:from-blue-900/20 to-purple-50/80 dark:to-purple-900/20 border-t border-gray-200 dark:border-slate-7 00">
            <button
              onClick={() => setFlyoverState({ isOpen: false, type: null, data: null })}
              className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-slate-800/50 rounded-lg border border-gray-200 dark:border-slate-700 
                hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-slate-700/50 dark:hover:border-slate-600 transition-all duration-200 
                shadow-sm hover:shadow active:scale-95 button-pop"
            >
              Cancel
            </button>
            {/* <button
